...
namespace server_dll { // server.dll
    constexpr std::ptrdiff_t NavGameTest001 = 0xA461A0;
    constexpr std::ptrdiff_t ServerToolsInfo_001 = 0x831570;
    constexpr std::ptrdiff_t Source2GameClients001 = 0x831580;
    constexpr std::ptrdiff_t Source2GameEntities001 = 0x831590;
    constexpr std::ptrdiff_t Source2Server001 = 0x8315A0;
    constexpr std::ptrdiff_t EmptyWorldService001_Server = 0x571B80;
    constexpr std::ptrdiff_t Source2ServerConfig001 = 0x565F00;
