...
pub mod server_dll { // server.dll
    pub const NavGameTest001: usize = 0xA461A0;
    pub const ServerToolsInfo_001: usize = 0x831570;
    pub const Source2GameClients001: usize = 0x831580;
    pub const Source2GameEntities001: usize = 0x831590;
    pub const Source2Server001: usize = 0x8315A0;
    pub const EmptyWorldService001_Server: usize = 0x571B80;
    pub const Source2ServerConfig001: usize = 0x565F00;
